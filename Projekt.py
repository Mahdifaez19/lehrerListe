...
def main():
    ...
    #print(LehrerListe)
    with open('jsonfile/db.json', 'w') as json_file:
        json.dump(LehrerListe, json_file)
    #res = zeileDurchsuchen(daten)
    #print(res[0])
    os.system('cd /home/mahdi/anaconda3/bin/pdf2txt.py /home/mahdi/Documents/VertretungsstundenAusfallen/jsonfile')
    os.system('git init')
    os.system('git remote add origin https://github.com/Mahdifaez19/lehrerListe')
    os.system('git add .')
    os.system('git commit -m "Fist commit"')
    os.system('git checkout master')
    os.system('git pull --rebase origin master')
    os.system('git push origin master')
    os.system('faez@web.de')
    os.system('oelpestbp19')
